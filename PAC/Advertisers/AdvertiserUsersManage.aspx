...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div >
        ...
        <asp:Panel ID="PlNewAdsUser" runat="server" Visible ="false">
            <asp:TextBox ID="txtFName" placeholder="First Name" runat="server" CssClass="txt1"></asp:TextBox>
            <asp:TextBox ID="txtPhone1" placeholder="Mobile Phone" runat="server" CssClass="txt1"></asp:TextBox><br />
            ...
            <br />
            <asp:TextBox ID="txtLName" placeholder="Last Name" runat="server" CssClass="txt1"></asp:TextBox>
            <asp:TextBox ID="txtPhone2" placeholder="Cell Phone" runat="server" CssClass="txt1"></asp:TextBox><br />
            ...
            <br />
            <asp:TextBox ID="txtEmail" placeholder="Email Address" runat="server" CssClass="txt1"></asp:TextBox>
            ...
            <br />
            <asp:TextBox ID="txtpswd" placeholder="Password" runat="server" CssClass="txt1"></asp:TextBox>
            <asp:TextBox ID="txtcopswd" placeholder="Confrim Password" runat="server" CssClass="txt1"></asp:TextBox><br />
