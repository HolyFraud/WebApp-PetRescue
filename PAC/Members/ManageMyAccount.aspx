...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <asp:SqlDataSource ID="FavouriteDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnectionString %>" SelectCommand="SELECT AnimalList.AnimalListID, AnimalList.Name, AnimalList.Age, AnimalList.Sex, AnimalTypeList.AnimalType, AnimalList.Color, AnimalBreedList.AnimalBreed FROM AnimalTypeList INNER JOIN AnimalList ON AnimalTypeList.AnimalTypeListID = AnimalList.AnimalTypeListID INNER JOIN AnimalBreedList ON AnimalList.AnimalBreedListID = AnimalBreedList.AnimalBreedListID INNER JOIN MemberFavouriteList ON AnimalList.AnimalListID = MemberFavouriteList.AnimalListID WHERE (MemberFavouriteList.MemberListID = @MemberListID) AND (MemberFavouriteList.RecordStatus = 1)">
            <SelectParameters>
                <asp:SessionParameter Name="MemberListID" SessionField="MemberMemberListID" />
            </SelectParameters>
        </asp:SqlDataSource>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <asp:Label ID="AdoptionFeeLabel" runat="server" Text='<%# Bind("AdoptionFee") %>' />
                ...
                <h2>My Favourite</h2>
                <telerik:RadGrid ID="FavouriteRadGrid"
                    runat="server"
                    AutoGenerateColumns="False"
                    DataSourceID="FavouriteDataSource"
                    AllowPaging="True"
                    AllowSorting="True">
